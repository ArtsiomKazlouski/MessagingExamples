...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationPrescription">
      ...
      <sch:assert test="exists(f:extention) and f:extension/@url='http://uiip/fhir/vs/medicament-type'">ext-1: Должно быть указано расширение MedicamentType</sch:assert>
    </sch:rule>
