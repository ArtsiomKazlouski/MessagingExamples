...
{  
    public class QuantityValue : ValueExpression
    {
        ...
        public override string ToString()
        {
            ...
            return PrimitiveTypeConverter.ConvertTo<string>(Number) /*Number.ConvertTo<string>() */+ "|" +
        ...
        public static QuantityValue Parse(string text)
        {
            ...
            var number = PrimitiveTypeConverter.ConvertTo<Decimal>(triple[0]);//triple[0].ConvertTo<Decimal>();
