...
namespace Hl7.Fhir.Tests.Model
{
...
#endif
    {
        ...
        public void BundleTypeHandling()
        {
            ...
            Assert.IsTrue(b.GetBundleType() == Bundle.BundleType.Unspecified);

            b.SetBundleType(Bundle.BundleType.Message);
            Assert.AreEqual(Bundle.BundleType.Message, b.GetBundleType());
            Assert.AreEqual(1,b.Tags.Count());

            b.SetBundleType(Bundle.BundleType.Document);
            Assert.AreEqual(Bundle.BundleType.Document, b.GetBundleType());
            Assert.AreEqual(1, b.Tags.Count());

            b.SetBundleType(Bundle.BundleType.Unspecified);
